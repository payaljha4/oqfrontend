...
function SuperAdminSideNavbar() {
    ...
    useEffect(() => {
        function getAccessToken(){
         ...
         authAxios.get("/customer/customer-details/")
         .then( (response)=>{
    ...
    const objectNav= [
        {
            id:1, title:'feed',icon:'fa fa-desktop' , Navlink:'/admin-dashboard-feed'
        },
        {
            id:2, title:'proposals',icon:'fa fa-user' , Navlink:'/admin-dashboard-proposal'
        },
        {
            id:3, title:'projects',icon:'fa fa-folder' , Navlink:'/admin-dashboard-projects'
        },
        {
            id:4, title:'job posts',icon:'fa fa-pencil-square' , Navlink:'/admin-dashboard-job-post'
        },
        {
            id:5, title:'OQ work history',icon:'fa fa-list' , Navlink:'/customer-history'
        },
        {
            id:6, title:'Settings',icon:'fa fa-cog' , Navlink:'/admin-dashboard-settings'
        },
        {
    ...
    // const [notification, setnotifiaction] = useState(true); 
    return (
                 ...
                 <div className="user_details_card">
                     ...
                     {isLoading?null:
                      (  <div className="info_user_card">
                        <p className="name_user_info" style={{textTransform:'capitalize'}}>{data.user.username}</p>
                      {data.user.is_verified?
                        <p className="other_user_info">
                        <img alt="is verified flag" src="https://icon-library.net//images/verified-icon-png/verified-icon-png-11.jpg" width="16" />
                        ...
                        {/* <p className="other_user_info">{data.category}</p> */}
                        <p className="other_user_info">{data.city}</p>
                    </div>)}
